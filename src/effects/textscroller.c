...
UWORD initTextScroller(void) {
    ...
    createStars(50, TEXTSCROLLER_VIEW_TEXTSECTION_WIDTH, TEXTSCROLLER_VIEW_TEXTSECTION_HEIGHT, MAX_CHAR_WIDTH, 0);
    paintStars(&ctx.textScrollerScreen0->RastPort, 6, 50);
